...
import { getLoginUrl, isManusOAuthEnabled } from "@/const";
import { useIsMobile } from "@/hooks/useMobile";
import { LayoutDashboard, LogOut, PanelLeft, Users, MessageSquare, History, Settings, Bot, Bell, Monitor, ShieldCheck, AlarmClock } from "lucide-react";
...
const menuItems = [
  ...
  { icon: ShieldCheck, label: "Chống Checkpoint", path: "/protection" },
  { icon: AlarmClock, label: "Lên lịch", path: "/scheduler" },
...
export default function DashboardLayout({
  ...
  if (!user) {
    // Redirect to /login page (local auth for Railway) or Manus OAuth
